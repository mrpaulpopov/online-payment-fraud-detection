...
CREATE TABLE test_transaction_time_features AS
SELECT
    "TransactionID",
    "TransactionDT",
    "TransactionAmt",
...
FROM step2
WHERE test_transaction_time_features."TransactionID" = step2."TransactionID";
...
ON test_transaction_time_features (
    "uid1",
    "DeviceInfo",
    "DeviceType",
    "TransactionDT"
...
UPDATE test_transaction_time_features t1
